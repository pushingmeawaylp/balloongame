 ...
 * 
 * @author mzechner */
public class CustomSpriteBatch extends SpriteBatch implements Disposable {
	private Mesh mesh;
	...
	public CustomSpriteBatch (int size, int buffers) {
	...
	protected void switchTexture (Texture texture) {
		renderMesh();
		//if(texture!=null && lastTexture!=null)
		//	System.out.println("Current texture : " + ((FileTextureData)lastTexture.getTextureData()).getFileHandle().path() + " New texture:" +  ((FileTextureData)texture.getTextureData()).getFileHandle().path());
		lastTexture = texture;
